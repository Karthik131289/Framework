#ifndef __BLOOMBERGOUTPUTWRITER_H__
#define __BLOOMBERGOUTPUTWRITER_H__
...
*/
class BloombergOutputWriter : public AbstractSimpleOutputWriter {
protected:
public:
	BloombergOutputWriter() {
	}
...
#endif //__BLOOMBERGOUTPUTWRITER_H__
