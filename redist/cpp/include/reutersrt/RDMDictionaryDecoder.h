...
public:
	...
	void	loadAppendix_A(const rfa::message::RespMsg& respMsg, bool moreFragments = false);
	void	loadEnumTypeDef(const rfa::message::RespMsg& respMsg, bool moreFragments = false);
