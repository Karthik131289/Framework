...
#include <stdlib.h> // KR, 14/10/2004
#include "md.h"
...
public:
	...
	MAPM(const char *s) /* Constructor from string */
		{create();m_apm_set_string(val(),(const char *)s);}
	...
	MAPM &operator=(const char *s) /* Assigment operator */
		{m_apm_set_string(val(),(const char *)s);return *this;}
