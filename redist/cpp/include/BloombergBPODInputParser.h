#ifndef __BLOOMBERGBPODINPUTPARSER_H__
#define __BLOOMBERGBPODINPUTPARSER_H__
...
#include <bpod_parameters.h>
#include <bpod_subscriber.h>
#include <bpod_exception.h>
#include <bpod_datadictionary.h>
#include <bpod_correlationid.h>
#include <time.h>

VOLANTE_NAMESPACE_BEGIN

class BloombergBPODInputParser : public InputParser  {
protected:
	BloombergBPODInputParser() {
	}
	~BloombergBPODInputParser() {
	}
public:
...
#endif //__BLOOMBERGBPODINPUTPARSER_H__
