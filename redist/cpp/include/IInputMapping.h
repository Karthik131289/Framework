#ifndef __IINPUTMAPPING_H__
#define __IINPUTMAPPING_H__
 ...
 *
 */
 class VOLANTE_EXPORT IInputMapping : public ICustomClass {
 public:
     ...
     */
    virtual void map(ExternalObject* input, NormalizedObject* nf, TransformContext& cxt) = 0;
};

VOLANTE_NAMESPACE_END

#endif //__IINPUTMAPPING_H__
