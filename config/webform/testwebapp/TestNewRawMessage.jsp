<%@ page language="java" session="true" contentType="text/html; UTF-8" %>
...
<center>
    ...
    <FORM NAME="RawMessageForm" METHOD="POST" enctype="multipart/form-data" ACTION="NewRawMessageAction.jsp">
        <TABLE class="TableStyle" cellpadding="0" cellspacing="0" border="0" width="90%" align="center">
            <TR>
                <TD class="Header" colspan="1" style="BORDER-RIGHT: none">
                    <p align="left"><B>&nbsp;Message</B><BR></p>
                </TD>
            ...
            <TR>
                <td class="DefaultLabelColumnStyle"><p style="margin-left: 0" class="DefaultLabelStyle">Message Name</p>
                </td>
                <td class="DefaultRendererColumnStyle">
                    <select name="MessageName" size="1" class="DefaultRendererStyle">
                        <%
                            String[] messages = LookupContextFactory.getLookupContext().getMessages();
               ...
               <%--     <input class="DefaultRendererStyle" type="text" size="40"
                                                              name="MessageName">--%>
			</TR>
            <TR>
                <td class="DefaultLabelColumnStyle"><p style="margin-left: 0" class="DefaultLabelStyle">Message Creation</p>
                </td>
                <TD class="DefaultRendererColumnStyle" style="margin-left:30px">
                    <input type="radio" value="new" checked name="MessageType"/><span style="margin-left: 0"
                                                                                          class="DefaultLabelStyle">New Message</span>
                    <br>
                    <input type="radio" value="parse" name="MessageType"/><span style="margin-left: 0"
                                                                                   class="DefaultLabelStyle">Parse Message</span>
                </TD>
            </TR>
            <TR>
                ...
                <TEXTAREA NAME="RawMessage" class="DefaultRendererStyle" ROWS="25" STYLE="WIDTH: 100%;margin-right: 25"><%=rawMessage%></TEXTAREA><br>
                </td>
                    </tr>
                </table>
                </td>
